...
##  <ManSection>
##    <Func Arg="package_name, documentation_file, path_to_xml_file" Name="CreateAutomaticDocumentation"/>
...
##      which you can simply include to your documentation. More methods to fully create a documentation will be provided soon.
##    </Description>
##  </ManSection>
##  <#/GAPDoc>
##
